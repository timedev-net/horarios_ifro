...
class FormularioHorario extends StatefulWidget {
  const FormularioHorario({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<FormularioHorario> createState() => _FormularioState();
}

class _FormularioState extends State<FormularioHorario> {
